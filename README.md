...
1. Market Supply & Demand: How are properties distributed by city, type, and features?
...
| Tool | Purpose |
|------|---------|
| Microsoft Power BI | Data modeling, ETL (via Power Query), interactive dashboard creation, and visualizations for trend analysis. |
| DAX (Data Analysis Expressions) | Creating measures for metrics like average prices, property counts, and comparisons (e.g., New vs. Old pricing). |
| Microsoft Excel  | Initial data cleaning, handling inconsistencies, and aggregation of raw listings data. |
...
* Key Performance Indicator (KPI) Cards:
  * Total Listings: 53,070
  * Cities Covered: 9 (e.g., Lekki, Ajah, Ikoyi, Island, Ikeja, Yaba, Surulere, Ojodu, Gbagada)
  * New Properties: 15,022

* Geographic Analysis: Property distribution and pricing by city/neighborhood.
* Property Type Breakdown: Houses vs. Apartments, New vs. Old, Furnished vs. Unfurnished.
...
1. Dominant Supply in Emerging Areas: Lekki and Ajah lead in listings, driven by rapid urban growth, while Ikoyi and Island have fewer but premium-priced properties.

2. Focus on New Developments: Over half of new builds are houses (vs. apartments), with more in Lekki, Ajah, and Ikoyi—indicating developer investment in high-growth zones.

3. Furnishing Trends: Lekki tops furnished listings, appealing to expatriates and short-term renters; mainland areas like Yaba and Surulere have fewer.

4. Pricing Variations: Ikoyi and Island command the highest averages; Ajah and mainland offer affordability. Prices rise with bedrooms, with sharp jumps for 3-5 beds in premium areas.
...
<img width="1257" height="702" alt="image" src="https://github.com/user-attachments/assets/f2c11e0a-9f53-41c7-9dae-c9f7640661ce" />

<img width="1251" height="708" alt="image" src="https://github.com/user-attachments/assets/68cd5488-dad8-4643-bc6b-c397b4f0464e" />
